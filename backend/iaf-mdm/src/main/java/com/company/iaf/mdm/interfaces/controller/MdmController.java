...
public class MdmController {
 ...
 @Operation(summary="Upload and precheck an Excel import file") @PostMapping(value="/{code}/imports",consumes=MediaType.MULTIPART_FORM_DATA_VALUE) public Result<MdmDtos.ImportPreview> previewImport(@PathVariable("code") String code,@RequestPart("file") MultipartFile file){return Result.ok(excel.preview(tenant(),code,file));}
