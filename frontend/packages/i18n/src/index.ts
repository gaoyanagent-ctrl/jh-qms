  ...
  'zh-CN': {
    translation: {
      ...
      mdm: {
        ...
        approval: { settingsTitle:'审批设置', requiredLabel:'记录生效需要审批', requiredHelp:'开启后，草稿提交进入“待审批”；关闭后提交即直接生效。此设置随模型版本发布。', roleLabel:'审批角色', roleHelp:'该角色下的用户会在“审批任务”中收到待办，并可批准或驳回。', currentStatus:'当前状态由审批流程控制', comment:'处理意见', commentPlaceholder:'填写本次操作的说明（驳回时必填）', history:'审批履历', versionHistory:'数据版本履历', noHistory:'尚无审批记录', task:{description:'来自主数据流程的真实待办、已办和我的申请。',businessCode:'业务编码',recordName:'主数据名称',model:'主数据模型',requester:'申请人'}, action:{SUBMIT:'提交',APPROVE:'批准',REJECT:'驳回',DEACTIVATE:'停用'} },
        ...
        status: { PUBLISHED: '已发布', DRAFT: '草稿', PENDING_APPROVAL:'待审批', REJECTED:'已驳回', ACTIVE: '生效', INACTIVE: '停用' },
  ...
  'en-US': {
    translation: {
      ...
      mdm: {
        ...
        approval: { settingsTitle:'Approval settings', requiredLabel:'Require approval before activation', requiredHelp:'When enabled, submitted drafts wait for approval. When disabled, submission activates the record immediately. This setting is published with the model version.', roleLabel:'Approver role', roleHelp:'Users in this role receive tasks in the Approval Task Center and can approve or reject.', currentStatus:'Current status is controlled by the approval workflow', comment:'Comment', commentPlaceholder:'Describe this action (required when rejecting)', history:'Approval history', versionHistory:'Data version history', noHistory:'No approval actions yet', task:{description:'Live MDM tasks, completed decisions, and requests started by you.',businessCode:'Business code',recordName:'Master data name',model:'Master data model',requester:'Requester'}, action:{SUBMIT:'Submitted',APPROVE:'Approved',REJECT:'Rejected',DEACTIVATE:'Deactivated'} },
        ...
        status: { PUBLISHED: 'Published', DRAFT: 'Draft', PENDING_APPROVAL:'Pending approval', REJECTED:'Rejected', ACTIVE: 'Active', INACTIVE: 'Inactive' }, changeReason: { create: 'Create master data', edit: 'Edit master data' }
      },
