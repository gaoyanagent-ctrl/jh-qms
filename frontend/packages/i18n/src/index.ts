  ...
  'zh-CN': {
    translation: {
      ...
      mdm: {
        ...
        approval: { settingsTitle:'审批设置', requiredLabel:'记录生效需要审批', requiredHelp:'开启后，草稿提交进入“待审批”，需由具备审批权限的用户批准后生效；关闭后提交即直接生效。此设置随模型版本发布。', currentStatus:'当前状态由审批流程控制', comment:'处理意见', commentPlaceholder:'填写本次操作的说明（驳回时必填）', history:'审批履历', versionHistory:'数据版本履历', noHistory:'尚无审批记录', action:{SUBMIT:'提交',APPROVE:'批准',REJECT:'驳回',DEACTIVATE:'停用'} },
  ...
  'en-US': {
    translation: {
      ...
      mdm: {
        ...
        approval: { settingsTitle:'Approval settings', requiredLabel:'Require approval before activation', requiredHelp:'When enabled, submitted drafts wait for an authorized approver. When disabled, submission activates the record immediately. This setting is published with the model version.', currentStatus:'Current status is controlled by the approval workflow', comment:'Comment', commentPlaceholder:'Describe this action (required when rejecting)', history:'Approval history', versionHistory:'Data version history', noHistory:'No approval actions yet', action:{SUBMIT:'Submitted',APPROVE:'Approved',REJECT:'Rejected',DEACTIVATE:'Deactivated'} },
