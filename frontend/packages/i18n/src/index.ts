  ...
  'zh-CN': {
    translation: {
      ...
      mdm: {
        ...
        approval: { currentStatus:'当前状态由审批流程控制', comment:'处理意见', commentPlaceholder:'填写本次操作的说明（驳回时必填）', history:'审批履历', versionHistory:'数据版本履历', noHistory:'尚无审批记录', action:{SUBMIT:'提交',APPROVE:'批准',REJECT:'驳回',DEACTIVATE:'停用'} },
