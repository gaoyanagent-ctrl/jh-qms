  ...
  'zh-CN': {
    translation: {
      ...
      mdm: {
        ...
        reference: { search: '搜索 {{model}} 主数据', incomplete: 'Reference 配置不完整', empty: '无匹配主数据' },
  ...
  'en-US': {
    translation: {
      ...
      mdm: {
        ...
        reference: { search: 'Search {{model}} master data', incomplete: 'Reference configuration is incomplete', empty: 'No matching master data' },
