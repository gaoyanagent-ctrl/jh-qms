  ...
  'en-US': {
    translation: {
      ...
      mdm: {
        ...
        status: { PUBLISHED: 'Published', DRAFT: 'Draft', PENDING_APPROVAL:'Pending approval', PENDING:'Pending approval', APPROVED:'Approved', REJECTED:'Rejected', ACTIVE: 'Active', INACTIVE: 'Inactive' }, changeReason: { create: 'Create master data', edit: 'Edit master data' }
      },
