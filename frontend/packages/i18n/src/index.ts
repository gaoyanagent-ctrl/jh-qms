  ...
  'zh-CN': {
    translation: {
      ...
      mdm: {
        ...
        sections: { basic: '基本信息' },
        actions: { openWorkspace: '打开数据工作台', createModel: '新建模型', designModel: '模型设计', versionHistory: '版本历史', excelPaste: 'Excel 粘贴导入' },
  ...
  'en-US': {
    translation: {
      ...
      mdm: {
        ...
        sections: { basic: 'Basic Information' }, actions: { openWorkspace: 'Open Data Workspace', createModel: 'Create Model', designModel: 'Model Designer', versionHistory: 'Version History', excelPaste: 'Paste from Excel' },
