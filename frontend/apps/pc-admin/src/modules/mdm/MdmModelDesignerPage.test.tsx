...
vi.mock('./hooks',()=>({useMdmSchema:()=>({data:schema,isError:false}),useMdmModels:()=>({data:[material,schema]}),useMdmValidationRules:()=>({data:validationRules,isLoading:false}),useSaveMdmValidationRules:()=>({mutate:vi.fn(),isPending:false}),useSaveMdmModelDraft:()=>({mutate:vi.fn(),isPending:false}),usePublishMdmModel:()=>({mutate:vi.fn(),isPending:false})}));
